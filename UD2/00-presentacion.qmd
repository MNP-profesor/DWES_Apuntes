...
|:---------:|--------|:---------:|
| EJ1 | Ficha de producto dinámica | No |
| EJ2 | Plantilla con cuatro zonas | No |
| EJ3 | Depurador: caza de errores | No |
| EJ4 | Panel de configuración | No |
| EJ5 | Practica con cadenas | No |
| EJ6 | Catálogo con cálculo de inventario | No |
| EJ7 | Validación de datos de texto | No |
| EJ8 | Ejercicios extras de Funciones de Strings | No |
| EJ9 | Desarrollo vs. producción | No |
| EJ10 | Motor de descuentos | No |
