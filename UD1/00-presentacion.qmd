...
|:---------:|--------|:---------:|
| EJ1 | Clasificación por lugar de ejecución | No |
| EJ2 | ¿Estático, dinámico embebido o script independiente? | No |
| EJ3 | Identificación de roles en una arquitectura real | No |
| EJ4 | Estudio comparativo razonado | No |
| EJ5 | Trazado manual de la salida | No |
